...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(5)();
	exports.push([module.id, ".slideShow {\n  position: relative;\n  float: left;\n  width: 600px;\n  height: 425px;\n  overflow: hidden; }\n  .slideShow, .slideShow ul, .slideShow .slideItems {\n    margin: 0;\n    padding: 0; }\n  .slideShow .slideItems {\n    position: relative;\n    display: block;\n    top: 0;\n    width: 100%;\n    height: 100%; }\n    .slideShow .slideItems .item {\n      position: absolute;\n      display: none;\n      opacity: 0;\n      zoom: 1;\n      width: 600px;\n      height: 425px; }\n      .slideShow .slideItems .item.cur {\n        display: block;\n        opacity: 1; }\n      .slideShow .slideItems .item:before {\n        background: rgba(0, 0, 0, 0.3);\n        bottom: 0;\n        content: '';\n        display: block;\n        left: 0;\n        position: absolute;\n        right: 0;\n        top: 0; }\n      .slideShow .slideItems .item .text_area {\n        position: absolute;\n        top: 5%;\n        left: 15px;\n        display: block;\n        width: 50%; }\n        .slideShow .slideItems .item .text_area .title {\n          display: block;\n          font-size: 40px;\n          font-weight: 300;\n          line-height: 54px;\n          color: #FFFFFF; }\n  .slideShow .control-dots {\n    position: relative;\n    display: block;\n    width: 100%;\n    left: 15px;\n    bottom: 30px; }\n    .slideShow .control-dots .dot {\n      display: block;\n      float: left;\n      width: 14px;\n      height: 14px;\n      margin-left: 6px;\n      cursor: pointer;\n      border-radius: 50%;\n      white-space: nowrap;\n      overflow: hidden;\n      opacity: 0.4;\n      background-color: #CFCFCF; }\n      .slideShow .control-dots .dot.cur {\n        background-color: #9C27B0;\n        opacity: 1; }\n", ""]);

/***/ }),
/* 21 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"slideShow\">\r\n\t<ul class=\"slideItems\">\r\n\t\t<li class=\"item\"  ms-for=\"($index,item) in @slideItems\" :css=\"{width:@image_width}\" :class=\"{cur: $index === @cur}\">\r\n\t\t\t<a class=\"link\" ms-attr=\"{href:@item.link}\">\r\n\t\t\t\t<div class=\"text_area animated fadeIn\">\r\n\t\t\t\t\t<h3 class=\"title\">\r\n\t\t\t\t\t\t{{@item.title}}\r\n\t\t\t\t\t</h3>\r\n\t\t\t\t</div>\r\n\t\t\t\t<img class=\"b-lazy\" ms-attr=\"{'src':@item.imgPath}\"/>\r\n\t\t\t</a>\r\n\t\t</li>\r\n\t</ul>\r\n\t<ul class=\"control-dots clearfix\">\r\n\t\t<li class=\"dot\" :class=\"{cur: $index === @cur}\" ms-for=\"($index,item) in @slideItems\" ms-click=\"@jump($index)\"></li>\r\n\t</ul>\r\n</div>"
